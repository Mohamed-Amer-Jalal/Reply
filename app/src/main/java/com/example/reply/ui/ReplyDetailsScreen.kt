    ...
    Box(modifier = modifier) {
        Button(
            ...
            colors = ButtonDefaults.buttonColors(
                containerColor = MaterialTheme.colorScheme.onErrorContainer.takeIf { containIrreversibleAction }
                    ?: MaterialTheme.colorScheme.primaryContainer
            )
        ) {
            Text(
                text = text,
                color = MaterialTheme.colorScheme.onError.takeIf { containIrreversibleAction }
